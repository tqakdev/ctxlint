...
const STOPWORDS = new Set([
  ...
  "are", "be", "it", "its", "this", "that", "these", "those", "do", "not",
  "don't", "never", "always", "must", "should", "use", "when", "before",
  "after", "into", "from", "them", "they", "your", "our", "you", "we", "as",
  "at", "by", "if", "any", "all", "one", "two", "here", "there", "was", "were",
]);
